...
@Configuration
@EnableConfigurationProperties(BootstrapWicketProperties.class)
@RequiredArgsConstructor
public class BootstrapWicketConfiguration {
    ...
    private final BootstrapWicketProperties properties;

    @Bean
    public FilterRegistrationBean<WicketFilter> bootstrapWicketFilter() {
        WicketFilter filter = new WicketFilter();
        FilterRegistrationBean<WicketFilter> registration = new FilterRegistrationBean<>(filter);
        registration.setName("wicket.bootstrap");
    ...
    @Bean
    public SecurityFilterChain bootstrapWicketFilterChain(HttpSecurity http) throws Exception {
        http
